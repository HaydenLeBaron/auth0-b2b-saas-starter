...
const MANAGEMENT_CLIENT_NAME = "Thesaurizate Management"
const DASHBOARD_CLIENT_NAME = "Thesaurizate Dashboard"
const DEFAULT_CONNECTION_NAME = "Thesaurizate-Shared-Database"
...
try {
  ...
  const createClientArgs = [
    ...
    "--description", "The Thesaurizate client to manage tenant resources and facilitate account creation.",
