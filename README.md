# **Thesaurizate** from Auth0 by Okta
...
### User Management
Invite additional users, change users' roles (and thus what they have permission to do in the application), and delete users. You'll notice as you perform these operations in Thesaurizate, you're changing the user database and organizations in your Auth0 tenant.
